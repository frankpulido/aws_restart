...
def runCaesarCipherProgram():
    ...
    print(f'Decrypted Message: {myDecryptedMessage}') # Fixed printing the correct variable

# Main logic
runCaesarCipherProgram()

print()
print("The error consisted on printing the wrong variable in the decryption step.")
print("The error was in Line 61, where the variable to print should be myDecryptedMessage, not myEncryptedMessage.")
print()
