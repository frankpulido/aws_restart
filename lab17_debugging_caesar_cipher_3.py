...
def decryptMessage(message, cipherKey, alphabet):
    ...
    return encryptMessage(message, decryptKey, alphabet) # Fixed using decryptKey instead of cipherKey
...
print()
print("The error consisted on the program working only with CipherKey = 13.")
print("The error was in Line 46 of decryptMessage module, where the atribute 'cipherKey' was used instead of 'decryptKey'.")
print("The reason that 'cipherKey = 13' worked is because it is right in the middle of the alphabet, position[13] = posiiton[-13]")
print()
