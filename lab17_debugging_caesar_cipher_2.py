...
def encryptMessage(message, cipherKey, alphabet):
    ...
    uppercaseMessage = message.upper() # Fixed casting to uppercase
...
print()
print("The error consisted on the program encryting only capital letters, and not lowercase letters.")
print("The error was in Line 33, where the variable needed to be casted to UPPERCASE")
print()
